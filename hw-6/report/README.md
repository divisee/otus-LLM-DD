...
- [8) Оценка результатов в Langfuse](#8-оценка-результатов-в-langfuse)
...
Аннотации в Langfuse — ручные метки качества (например, лайк/дизлайк), которые помогают собирать обратную связь, готовить данные для последующей разметки и дообучения, а также быстро оценивать качество ответов и шагов пайплайна.

В Langfuse добавлена аннотация типа boolean `LIKE` (0/1). Пример простановки аннотации:
