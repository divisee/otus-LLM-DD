...
- Эмбеддинги базы (100 фильмов): ~3 сек
- 10 RAG-запросов: ~15 сек
- RAGAS оценка (10 примеров, 4 метрики): ~5-7 мин
- LLM Judge (10 примеров): ~13 сек
- Install dependencies: ~30 сек
- **Итого в GitHub Actions: ~6 мин**
